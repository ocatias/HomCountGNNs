...
do
    ...
    python Exp/run_experiment.py -grid "Configs/Eval/gcn_without_features.yaml" -dataset "${dataset[i]}" --candidates 50  --repeats 10 --graph_feat "Counts/Current/${counts_cur_path[i]}"
