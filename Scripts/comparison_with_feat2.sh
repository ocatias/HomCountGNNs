declare -a dataset=("ogbg-moltox21" "ogbg-molesol" "ogbg-molclintox")
...
declare -a counts_cur_path=("OGBG-MOLTOX21_full_kernel_max_50_il3.homson" "OGBG-MOLESOL_full_kernel_max_50_il3.homson" "OGBG-MOLCLINTOX_full_kernel_max_50_il3.homson")
declare -a counts_baseline_path=("OGBG-MOLTOX21_tree+cycle_6_50_il3.homson" "OGBG-MOLESOL_tree+cycle_6_50_il3.homson" "OGBG-MOLCLINTOX_tree+cycle_6_50_il3.homson")
