declare -a dataset=("ogbg-molbace" "ogbg-molbbbp")
...
declare -a counts_cur_path=("OGBG-MOLBACE_full_kernel_max_50_il3.homson" "OGBG-MOLBBBP_full_kernel_max_50_il3.homson")
